...
<body>
    ...
    <header>
        <nav id="kadeHeader" class="fixed-top navbar navbar-expand-lg">
            <div class="container">
                <!-- Pizza kade logo -->
                <a class="nav-link" href="<?php echo base_url(); ?>index.php/pizzaNowHome/index">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="<?php echo base_url(); ?>index.php/pizzaNowHome/index"><i
                                    class="fas fa-home fa-fw"></i> Home
                                <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url(); ?>index.php/menu"><i
                                    class="fa fa-pizza-slice fa-fw"></i>
                                Menu</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url(); ?>index.php/order"><i
                                    class="fas fa-clipboard-list"></i>
                                Order</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url(); ?>index.php/delivery/index"><i
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>index.php/cart" class="nav-link d-flex flex-row">
                                <h3><span class="badge badge-success badge-secondary"><?php echo $cartCount ?></span>
                                </h3>
