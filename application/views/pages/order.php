                        ...
                        <div class="pt-4">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <form action="<?php echo base_url("index.php/order/checkout"); ?>" method="post">
                                        <div class="row mx-4">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <span
                                                    class="error-messages mt-3"><?php echo form_error('first-name'); ?></span>
                                            </div>
                                            <div class="col-12 col-sm-6 mt-2 mt-sm-0">
                                                <input id="last-name" name="last-name" class="order-confirm-form-input"
                                                    placeholder="Last Name">
                                                <span
                                                    class="error-messages"><?php echo form_error('last-name'); ?></span>
                                            </div>
                                        ...
                                        <div class="row mt-3 mx-4">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <span
                                                    class="error-messages mt-3"><?php echo form_error('mobile'); ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-3 mx-4">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <span
                                                    class="error-messages mt-3"><?php echo form_error('address-line-one'); ?></span>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-6 mt-2 pr-sm-2">
                                                <input id="city" name="city" class="order-confirm-form-input"
                                                    placeholder="City">
                                                <span
                                                    class="error-messages mt-3"><?php echo form_error('city'); ?></span>
                                            </div>
                                            <div class="col-12 col-sm-6 mt-2 pl-sm-0">
                                                <input id="region" name="region" class="order-confirm-form-input"
                                                    placeholder="Region">
                                                <span
                                                    class="error-messages mt-3"><?php echo form_error('region'); ?></span>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="price float-right">
                                        <span>LKR </span><span><?php echo sprintf('%0.2f', $subTotal) ?></span>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <strong>Tax</strong>
                                ...
                                <div class="col-md-12">
                                    <strong>Total</strong>
                                    <div class="price float-right">
                                        <span>LKR </span><span><?php echo sprintf('%0.2f', $total) ?></span>
                                    </div>
                                    <hr>
                                </div>
