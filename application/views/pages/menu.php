...
<section class="bright py-5">
    <div class="container">
                                    ...
                                    <div clas="col-sm-9">
                                        <div class="p-3">
                                            <div class="text-center">
                                                ...
                                                <p class="menu-price">
                                                    R:
                                                    <?php echo sprintf('%0.2f', $pizza['price'] * ($sizes[0]['price_percentage'] / 100) + $pizza['price']) ?>
                                                    &nbsp;&nbsp;
                                                    M:
                                                    <?php echo sprintf('%0.2f', $pizza['price'] * ($sizes[1]['price_percentage'] / 100) + $pizza['price']) ?>
                                                    &nbsp;&nbsp;
                                                    L:
                                                    <?php echo sprintf('%0.2f', $pizza['price'] * ($sizes[2]['price_percentage'] / 100) + $pizza['price']) ?>
                                                </p>
        ...
        <section class="bright py-3" id="special">
            <div class="container">
                <div class="container">
                    <h2 class="section_heading">SPECIAL MEALS</h2>
                    <div class="row mt-3">

                        <?php foreach ($items as $item): ?>
                        <?php if ($item['category'] == "SPECIAL_MEAL"): ?>
                        <article class="col-lg-4">
                            <div class="pizza-box m-3 shadow">
                                <div class="row">
                                    <div clas="col-sm-3">
                                        ...
                                        <div clas="col-sm-9">
                                            <div class="p-3">
                                                <div class="text-center">
                                                    ...
                                                    <a class="order-button btn btn-main mt-1"
                                                        href="<?php echo base_url('index.php/cart/addItemToCart/' . $item['id']); ?>">
